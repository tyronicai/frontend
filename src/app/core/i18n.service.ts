...
export class I18nService {
	 ...
	 */
	get language(): string {
		if (this.translateService == undefined) return environment.defaultLanguage;

		if (this.translateService.currentLang == undefined) return environment.defaultLanguage;
